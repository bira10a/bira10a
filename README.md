...
<p align="left"> <strong>Я занимаюсь Frontend разработкой и UX/UI‑дизайном.</strong><br> 
  С 2021 года наслаждаюсь версткой сайтов и проектирую пользовательские интерфейсы (UX/UI‑дизайн).<br>
  В последнее время пишу на React + TS, SCSS + анимация как личного написания, так и с подключением библиотек. <br>
  - 💻 Использумый стек в настощее время: Vite, React + TS, SCSS, Figma.<br>- 📚 Считаю Frontend разработку и UX/UI‑дизайн не просто работой, но и одним из шикарнейшим времяпровождением, пожирающего много времени, которого на это не жалко))<br>- 📞 Высокая комуникабельность и понимание как без этого никуда. <br>- ⚡ Есть опыт в высонагруженной команде, успешные коммуникации с Заказчиками, решение конфликтных ситуаций и управленческий опыт, ведение нескольких проектов одновременно, в т.ч. проблемных <br>- 💯 Понимание о влиянии удобного и запоминающегося дизайна, скоростного и впечатляющего сайта на конверсию.</p>

###

<h3 align="left">🛠 Технологии:</h3>
<p align="left">
  <strong>Уверенные знания:</strong> <br>
  <i>- UX/UI‑дизайн:</i> Figma, Adobe Photoshop, Adobe Illustrator.<br>
  <i>- верстка и логика SPA, MPA:</i> Html, Css, Scss, JS, Styled Components, React, TS, {...различные библиотеки для анимации}.<br>
  <i>- cборка проекта:</i> Vite, webpack, gulp.<br>
  <i>- редко, но метко no-code:</i> Webflow, Tilda (Zero Block).
</p>
###
...
<div align="left">
  ...
  <img src="https://skillicons.dev/icons?i=webflow" height="40" alt="webflow logo"  />
      <img width="12" />
  <img src="https://raw.githubusercontent.com/bira10a/bira10a/master/tilda-icon-logo.svg" height="40" alt="tilda logo"  />
</div>
