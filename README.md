...
<p align="left"> <strong>Я занимаюсь Frontend разработкой и UX/UI‑дизайном.</strong><br> 
  С 2021 года занимаюсь версткой сайтов и проектирую пользовательские интерфейсы (UX/UI‑дизайн).<br>
  В последнее время пишу на React + TS <br>
  - 💻 Использумый стек в настощее время: React + TS, Figma.<br>- 📚 Frontend разработка для меня не просто работа, но и увлекательное хобби и то от чего я получаю удовольствие)<br>- ⚡ Постоянная и беспрерывная коммуникация с коллегами по цеху и с людьми с разных направлений и профессий <br>- 📞 Есть опыт в высонагруженной команде, решении конфликтных ситуаций и управленческий опыт, ведение нескольких проектов одновременно, в т.ч. и проблемных</p>

###

<h3 align="left">🛠 Технологии:</h3>
<p align="left">
  Уверенные знания Html, Css, Scss, JS
</p>
###
